...
,userStatus
  ...
  function onAttention(timestampBegin, timestampEnd, score) {
    ...
    axios.post("http://192.168.31.200:7777/class/attention-rate/time-series",{
      "classNo": lessonNo,
...
function clearCanvas() {
  ...
  <canvas id="output" style={{position: "fixed", zIndex: 9999}}></canvas>
    {
    ...
    <Link to={`/lessonroom/${lessonNo}/${lessonRoundNo}/student`}
    >
